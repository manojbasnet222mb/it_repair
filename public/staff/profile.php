<?php
/**
 * Staff Profile — NexusFix (Ultimate Edition)
...
require_role('staff', 'admin'); // Allow both staff and admin roles

// Validate session data
if (!isset($_SESSION['user']) || !is_array($_SESSION['user']) || !isset($_SESSION['user']['id'])) {
    app_log('error', "Invalid session data for staff profile access.");
...
<head>
  ...
  <meta name="description" content="Update your staff profile information and contact details.">
  <title>My Profile — NexusFix Staff</title>
  ...
  <main aria-labelledby="page-title">
    <div style="display:flex;justify-content:space-between;align-items:start;flex-wrap:wrap;gap:1rem;margin-bottom:1.5rem;">
      <div>
        ...
        <p class="subtitle">Update your staff profile information and contact details.</p>
      </div>
    ...
    <form method="post" class="profile-form" enctype="multipart/form-data" novalidate>
      ...
      <div class="actions">
        ...
        <a href="<?= e(base_url('staff/dashboard.php')) ?>" class="btn subtle">Back to Dashboard</a>
      </div>
    </form>
  </main>
